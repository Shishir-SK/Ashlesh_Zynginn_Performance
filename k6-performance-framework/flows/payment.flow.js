...
export function paymentFlow(authData) {
  group('Payment Flow', () => {
    // All payment endpoints require Razorpay keys - skipping all payment APIs
    console.log('Payment flow skipped - all payment endpoints require Razorpay configuration');
    
    // Future: When Razorpay keys are available, uncomment these endpoints:
